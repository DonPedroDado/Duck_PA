...
def test_ask_ai_for_multiple_choice_test(mock_generate_content):
...
@patch('Duck_PA.AI.ask_ai.model.generate_content')
def test_ask_ai_for_true_false_test(mock_generate_content):
...
@patch('Duck_PA.AI.ask_ai.model.generate_content')
def test_ask_ai_for_fill_in_blank_test(mock_generate_content):
...
@patch('Duck_PA.AI.ask_ai.model.generate_content')
def test_ask_ai_invalid_test_type(mock_generate_content):
...
@patch('Duck_PA.AI.ask_ai.model.generate_content')
def test_ask_ai_error_handling(mock_generate_content):
